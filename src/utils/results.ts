...
import { getConstructorStandings2 as getConstructorStandings, getDriverStandings2 as getDriverStandings} from "./F1data";
...
export default async function () {
    var drivers: DriverStanding[] = await getDriverStandings();
    var constructors: ConstructorStanding[] = await getConstructorStandings();
